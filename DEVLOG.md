...
| 21. jun 2026 | (denne commit) | **Iterasjon 5** — Konsistens-fiks: naturtypeportrettet får også `praktiskeDesigntiltak` med samme kategorisering (lovstyrt vs frivillig) som artsportrett og planteportrett fikk i iter 2. Tilpasset prompt for naturtype-kontekst (kantsoneverning, hensynssoner, utvalgte naturtyper) |
